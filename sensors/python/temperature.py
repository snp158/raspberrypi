...
# 27(BMC)BUSSER illumination if gas ALARM
DH11             = 11
PIN_DH11_SENSOR  = 4
PIN_MQ2_SENSOR   = 17
PIN_ALARM_GAS    = 27
...
def setup():
    ...
    GPIO.setFunction(PIN_LIGHT_SWITCH, GPIO.OUT)
    GPIO.digitalWrite(PIN_LIGHT_SWITCH, GPIO.LOW)
#===========================================
#
...
def BTN22(iONOFF):
   ion=int(iONOFF)
   GPIO.digitalWrite(PIN_LIGHT_SWITCH,ion)
   print ("ONOFF=",iONOFF)
